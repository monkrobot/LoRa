...
//Version2 Display and parsing don't work
#include <SSD1306.h> // alias for `#include "SSD1306Wire.h"`
...
void receiver() {
  ...
  // try to parse packet
  int packetSize = LoRa.parsePacket();
  Serial.print("LoRa.parsePacket packetSize ");
...
LoRa Frequency: 433000000.00
LoRa Spreading Factor: 9
LoRa.parsePacket packetSize 0
LoRa Signal Bandwidth: 31250.00*/